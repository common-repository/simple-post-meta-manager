...
1. Install Simple Post Meta Manager either via the WordPress.org plugin directory, or by uploading the files to your server
2. Activate the plugin through the 'Plugins' menu in WordPress
3. (optional) Configure the plugin settings in POSTS -> META MANAGER
